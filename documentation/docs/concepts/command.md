...
As with Events, `BorrowBook` is the spoken form. In the model the Command carries the bare verb, `borrow`, under the Aggregate `book`; the **[Naming](/concepts/event.md#naming)** section of the Event page explains how the two relate.
