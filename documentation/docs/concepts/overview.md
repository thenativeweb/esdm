...
If you're new to Event Sourcing or Domain-Driven Design, read this chapter linearly. If you're looking for a specific term, navigate to it directly from the sidebar. To put the vocabulary into practice, the **[Modeling Guides](/modeling-guides/overview.md)** walk through example domains end to end. To see how this vocabulary extends with behavioral specifications and discovery stories, head to the **[Extensions](/extensions/overview.md)**. To look up the schema fields each kind has, the **[Reference](/reference/core-schema/overview.md)** is the canonical place.
